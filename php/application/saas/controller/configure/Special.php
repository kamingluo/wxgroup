...
class Special
{
   ...
   public function querylist(Request $request){
    ...
    $data = db()->table(array('crowd_coupon_code_exchange'=>'t1','user'=>'t2','crowd_coupon_code'=>'t3'))->field('t1.id,t1.user_id,t2.nickName,t3.code,t1.create_time')->where('t2.id=t1.user_id')->where('t3.id=t1.coupon_id')->order('id ASC')->limit($number,10)->select();
