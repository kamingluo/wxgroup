...
class Score
{
    ...
    public function scoreranking(Request $request)
    {
      ...
      $sql = "select user.nickName,user.avatarUrl,user_crowd.score from user,user_crowd where user.id=user_crowd.user_id and user_crowd.crowd_id = ".$crowd_id." order BY user_crowd.score desc,user_crowd.id desc LIMIT ".$startnumber.",20;";
