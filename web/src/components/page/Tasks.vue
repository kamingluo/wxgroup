  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item
          ><i class="el-icon-lx-cascades"></i> 总任务数：{{datapages}}</el-breadcrumb-item
        >
      </el-breadcrumb>
    </div>
    <div class="container">
    ...
    <div class="handle-box">
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable">
        ...
        <el-table-column prop="explain" label="任务描述" width="260">
        </el-table-column>
        <el-table-column prop="create_time" label="创建时间" width="160">
        </el-table-column>
        <el-table-column prop="state" label="审核状态" width="120">
        <template slot-scope="scope">
        <el-text>{{scope.row.state==0?"未审核":scope.row.state==1?"审核成功":"审核失败"}}</el-text>
         </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    newsearch(){
        ...
        this.select_word="";
        this.select_cate="1";
        let url = "configure/tasks/taskslist";
