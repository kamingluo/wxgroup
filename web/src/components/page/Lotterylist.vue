  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item
          ><i class="el-icon-lx-cascades"></i> 总发布数：{{datapages}}</el-breadcrumb-item
        >
      </el-breadcrumb>
    </div>
    <div class="container">
    ...
    <!--  <div class="handle-box">
      ...
      <el-table-column prop="id" label="活动id" width="80"> </el-table-column>
        ...
        <el-table-column prop="goods_name" label="奖品名称" width="250">
         ...
         <el-table-column prop="goods_img" label="奖品图片" width="120">
          <template slot-scope="scope" style="height:100px">
            <img class="logo" :src="scope.row.goods_img"></img>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="state" label="开奖状态" width="120">
        <template slot-scope="scope">
        <el-text>{{scope.row.state==0?"未开奖":scope.row.state==1?"已经开奖":"开奖失败"}}</el-text>
         </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.url = "configure/datalist/lotterylist";
    ...
    newsearch(){
        ...
        this.select_word="";
        this.select_cate="1";
        let url = "configure/datalist/lotterylist";
