  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item
          ><i class="el-icon-lx-cascades"></i> 总兑换数：{{datapages}}</el-breadcrumb-item
        >
      </el-breadcrumb>
    </div>
    <div class="container">
    ...
    <div class="handle-box">
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable">
        ...
        <el-table-column prop="provinceName" label="省份" width="80">
         ...
         <el-table-column prop="countyName" label="地区" width="80">
        </el-table-column>
         <el-table-column prop="detailInfo" label="详细地址" width="260">
        </el-table-column>
         <el-table-column prop="postalCode" label="邮政编码" width="80">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.url = "configure/exchangelist/exchangelist";
    ...
    newsearch(){
        ...
        this.select_word="";
        this.select_cate="1";
        let url = "configure/exchangelist/exchangelist";
    ...
    confirmdelete(){
     ...
     let url = "configure/exchangelist/deleteexchange?id=" + id;
